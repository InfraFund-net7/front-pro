...
| `NEXT_PUBLIC_BASE_URL` | Yes | Backend API base URL. For local testing use the local backend base URL | Local backend runtime |
...
2. Set `NEXT_PUBLIC_BASE_URL` to the local backend URL.
