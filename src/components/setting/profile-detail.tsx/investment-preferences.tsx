        ...
        <CardView className="rounded-xl gap-6 p-6 h-full">
            ...
            <div className="flex justify-between items-center gap-6 w-full">
                <Dropdown
                    ...
                    className='w-76.5'
                    onChange={(value) => handleDropdownChange(value, 'riskTolerance')}
                ...
                <FormInput
                    ...
                    onChange={(e) => handleInputChange('sectorFocus', e.target.value)}
                />
                <FormInput
            ...
            <div className='gap-6 flex flex-col w-full h-28'>
                <span className='text-base font-medium text-[#C9D1D9]'>Registered Address</span>
                <textarea
