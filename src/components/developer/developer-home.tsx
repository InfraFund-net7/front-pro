    ...
    return (
        <div className="min-h-screen flex flex-col gap-12 text-white">
                        ...
                        <div className="flex flex-col lg:flex-row">
                            ...
                            <div className="flex-1 p-6">
                                <div className="flex items-start justify-between mb-4">
                                    <div>
                                        <h3 className="text-xl font-bold mb-2">Exeter Community Solar Farm</h3>
                                        <span className="inline-block bg-red-600 text-red-100 text-xs font-bold px-3 py-1 rounded-full">
                                            UNDER REVIEW
                                        </span>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-4">
                                        <div className="flex items-center gap-2 text-green-400">
                                            ...
                                            <span className="text-sm font-bold">AI Risk Score: Low</span>
                                        </div>
                                ...
                                <div className="mb-4">
                                    <p className="text-gray-400 text-sm mb-2">
                                        Application Status: <span className="text-white font-bold">Complete</span> | Next Step:{" "}
                                        <span className="text-white">Financial Feasibility</span>
                                    </p>

                                    <div className="mb-2">
                                        <p className="text-gray-400 text-sm mb-1">Review Progress 0%</p>
                    ...
                    <div className="bg-[#1F2937] border border-[#374151] rounded-lg overflow-hidden">
                        <div className="flex flex-col lg:flex-row">
                            ...
                            <div className="flex-1 p-6">
                                <div className="flex items-start justify-between mb-4">
                                    <div>
                                        <h3 className="text-xl font-bold mb-2">Cornwall Wind turbine Pilot</h3>
                                        <span className="inline-block bg-yellow-600 text-yellow-100 text-xs font-bold px-3 py-1 rounded-full">
                                ...
                                <div className="mb-4">
                                    <p className="text-gray-400 text-sm mb-2">
                                        Gas fee: <span className="text-white font-bold">0.000000001 ETH</span> | Blockchain:{" "}
                                        <span className="text-white">Ethereum</span> | Next Step:{" "}
                                        <span className="text-white">Waiting for registration</span>
                                    </p>

                                    <div className="mb-2">
                                        <p className="text-gray-400 text-sm mb-1">Registration Progress 0%</p>
                                        <div className="w-full bg-gray-800 rounded-full h-2">
                                            <div className="bg-gray-700 h-2 rounded-full" style={{ width: "0%" }}></div>
                                        </div>
                                    </div>
                    ...
                    <div className="bg-[#1F2937] border border-[#374151] rounded-lg overflow-hidden">
                        <div className="flex flex-col lg:flex-row">
                            ...
                            <div className="flex-1 p-6">
                                ...
                                <div className="mb-4">
                                    <p className="text-gray-400 text-sm mb-2">
                                        Vote Amount: <span className="text-white font-bold">3100/6000</span> | Next Step:{" "}
                                        <span className="text-white">Waiting for result</span>
                                    </p>

                                    <div className="mb-2">
                                        <p className="text-gray-400 text-sm mb-1">Voting Progress 51%</p>
                                        <div className="w-full bg-gray-800 rounded-full h-2">
                                            <div className="bg-fuchsia-500 h-2 rounded-full" style={{ width: "51%" }}></div>
                                        </div>
                                    </div>
                    ...
                    <div className="bg-[#1F2937] border border-[#374151] rounded-lg overflow-hidden">
                        <div className="flex flex-col lg:flex-row">
                            ...
                            <div className="flex-1 p-6">
                                <div className="flex items-start justify-between mb-4">
                                    ...
                                    <div className="flex items-center gap-4">
                                        <div className="flex items-center gap-2 text-yellow-400">
                                            ...
                                            <span className="text-sm font-bold">AI Risk Score: Medium</span>
                                        </div>
                                ...
                                <div className="mb-4">
                                    <p className="text-gray-400 text-sm mb-2">
                                        Raised Amount: <span className="text-white font-bold">£350k / £500k</span> | Investors:{" "}
                                        <span className="text-white">78</span> | Closing Date:{" "}
                                        <span className="text-white">23-10-2027</span>
                                    </p>

                                    <div className="mb-2">
                                        <p className="text-gray-400 text-sm mb-1">Funding Progress: 70%</p>
                                        <div className="w-full bg-gray-800 rounded-full h-2">
                    ...
                    <div className="bg-[#1F2937] border border-[#374151] rounded-lg overflow-hidden">
                        <div className="flex flex-col lg:flex-row">
                            ...
                            <div className="flex-1 p-6">
                                ...
                                <div className="mb-4">
                                    <p className="text-gray-400 text-sm mb-2">
                                        Project Status: <span className="text-white font-bold">Active</span> | General Contractor:{" "}
                                        <span className="text-white">Solardeveloper.co</span> | Next Milestone:{" "}
                                        <span className="text-white">Panel Installation</span>
                                    </p>

                                    <div className="mb-2">
                                        <p className="text-gray-400 text-sm mb-1">Construction Progress: 67%</p>
                                        <div className="w-full bg-gray-800 rounded-full h-2">
                                            <div className="bg-lime-500 h-2 rounded-full" style={{ width: "67%" }}></div>
                                        </div>
                                    </div>
                    ...
                    <div className="bg-[#1F2937] border border-[#374151] rounded-lg overflow-hidden">
                        <div className="flex flex-col lg:flex-row">
                            ...
                            <div className="flex-1 p-6">
                                ...
                                <div className="mb-4">
                                    <p className="text-gray-400 text-sm mb-2">
                                        Return Rate: <span className="text-white font-bold">12%</span> | Investors:{" "}
                                        <span className="text-white">78</span> | Next Maintenance:{" "}
                                        <span className="text-white">02-03-2028</span>
                                    </p>

                                    <div className="mb-2">
                                        <p className="text-gray-400 text-sm mb-1">Return Progress: 67%</p>
                                        <div className="w-full bg-gray-800 rounded-full h-2">
            ...
            <div className="border border-[#30363D] p-6 rounded-2xl">
                <h2 className="text-2xl font-bold mb-6">Critical Alerts & Notifications</h2>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-gray-300 mb-3">
                                    Cornwall Geothermal: Predictive analysis indicates potential 3-day delay on Milestone 4 due to sensor
                                    data anomalies from Drilling Rig B. Recommended action: Schedule maintenance check.
                                </p>
                    ...
                    <div className="border border-[#E5E7EB] rounded-lg p-6 relative">
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-gray-300 mb-3">
                                    Exeter Solar: Funding deadline approaching (7 days). Engagement metrics are strong.
                                </p>
                    ...
                    <div className="border border-[#E5E7EB] rounded-lg p-6 relative">
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-gray-300 mb-3">
                                    Q4 Regulatory Report due for Cornwall Geothermal (Submit by Nov 15).
                                </p>
